              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image.asset(
                        'assets/images/united-kingdom@3x.png',
                        height: 30,
                      ),
                      const Spacer(),
                      Text(
                      ...
                      Obx(() => Opacity(
                          ...
                          child: Image.asset(
                            'assets/images/Group 7053@3x.png',
                            height: 25,
                          ))),
                    ],
                  ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image.asset(
                        'assets/images/united-arab-emirates@3x.png',
                        height: 30,
                      ),
                      const Spacer(),
                      Text(
                      ...
                      Obx(() => Opacity(
                          opacity:
                              controller.selectedLanguage.value == 'ar' ? 1 : 0,
                          child: Image.asset(
                            'assets/images/Group 7053@3x.png',
                            height: 25,
                            width: 25,
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Obx(() => Opacity(
                          opacity:
                              controller.selectedLanguage.value == 'ku' ? 1 : 0,
                          child: Image.asset('assets/images/Group 7053@3x.png',
                              height: 25))),
                    ],
                  ),
                ),
          ...
          child: GestureDetector(
              onTap: () async {
                ...
                if (widget.pageName == 'setting') {
                  await controller
                      .updateLanguage(controller.selectedLanguage.value);
                  Get.back();
                } else {
