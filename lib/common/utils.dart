...
Text addText(String text, double size, Color color, FontWeight fontWeight, {int? maxLines, String? fontFamily, double letterSpacing = 0}) {
  return Text(
    text.tr,
